        ...
        <div class="flex flex-col w-full items-center">
            ...
            <div class="flex flex-col md:border md:rounded-lg md:m-3 w-3/4 bg-white items-center">
                ...
                <div class="p-3 text-[#828282] flex flex-row justify-between w-full items-center">
                    <div class="text-base font-medium">Información de Permisos</div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                            <tr>
                                                ...
                                                <div>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">danky@danky.com</p>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap flex justify-center gap-2">
            ...
            <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden flex items-center justify-center fixed top-0 left-0 right-0 z-50 w-screen h-screen p-4 bg-gray-500/50 md:inset-0">
                <!-- cuadro -->
                <div class="flex flex-col items-center relative w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-700 p-4 lg:px-8">
                    ...
                    <div class="">
                        <h3 class="font-semibold text-2xl text-center my-2">Editar Permiso</h3>
                    </div>
                    ...
                    <form action="../php/password.php" method="post" id="passwordForm" class="w-full flex flex-col gap-6 relative text-gray-500 mt-4" acction="#">
                        ...
                        <div class="flex flex-col w-full">
                            <label for="dni" class="font-semibold">Email de Usuario</label>
                            <input type="text" id="dni" name="dni" placeholder="Ingrese su Email" class="border border-stone-400 rounded-lg h-8 p-1" />
                        </div>

                        <div class="flex flex-col w-full">
                            <label for="email" class="font-semibold">Rol de usuario</label>
