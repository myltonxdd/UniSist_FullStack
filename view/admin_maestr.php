    ...
    <div class="flex flex-row bg-[#f5f6fa] h-screen ">
        ...
        <div class="flex flex-col w-full items-center">
            ...
            <div class="flex flex-row items-center justify-between w-full px-5 py-3">
                <h2 class="text-2xl">Lista de Maestros</h2>
            ...
            <div class="flex flex-col md:border md:rounded-lg md:m-3 bg-white items-center">
                ...
                <div class="p-3 text-[#828282] flex flex-row justify-between w-full items-center">
                    ...
                    <div id="agregAlumn" class="border rounded-md cursor-pointer bg-blue-600 text-white p-2 text-xs">Agregar Maestro</div>
                                ...
                                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead class="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                <th scope="col" class="py-3.5 px-4 text-sm font-semibold text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                ...
                                                <th scope="col" class="px-12 py-3.5 text-sm font-semibold text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    Nombre
                                                </th>

                                                <th scope="col" class="px-4 py-3.5 text-sm font-semibold text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    Email
                                                </th>
