        ...
        <div class="flex flex-col w-full items-center">
            ...
            <div class="flex flex-col md:w-3/4 md:border md:rounded-lg md:m-3 bg-white items-center">
                ...
                <div class="p-3 text-[#828282]">
                    <div class="text-base font-medium">Calificaciones y mensajes de tus clases</div>
                </div>
                <hr class=" border-[#afb1b7]">
                <!-- component -->
                <section class="container px-4 mx-auto">
                    <div class="mt-6 md:flex md:items-center md:justify-between">
                        <div class="inline-flex bg-[#6c747e] border divide-x rounded-lg dark:bg-gray-900 rtl:flex-row-reverse dark:border-gray-700 dark:divide-gray-700">
                            <button class="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 hover:bg-gray-100 sm:text-sm dark:bg-gray-800 dark:text-gray-300">
                                Copy
                            </button>
                            ...
                            <button class="flex group relative px-5 py-2 text-xs justify-center items-center font-medium text-gray-600 transition-colors duration-200 sm:text-sm dark:hover:bg-gray-800 dark:text-gray-300 hover:bg-gray-100">
                                <p>Column Visivility</p>
                                <img src="../recursos/icons/flechIzq.svg" alt="">
                                <div class="absolute hidden top-full min-w-full w-max shadow-md mt-1 rounded group-focus:block">
                                    <ul class="text-left rounded-lg border bg-white">
