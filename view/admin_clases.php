    ...
    <div class="flex flex-row bg-[#f5f6fa] h-screen ">
        ...
        <div class="flex flex-col w-full items-center">
            ...
            <div class="flex flex-row items-center justify-between w-full px-5 py-3">
                <h2 class="text-2xl">Lista de Clases</h2>
            ...
            <div class="flex flex-col md:border md:rounded-lg md:m-3 w-3/4 bg-white items-center">
                ...
                <div class="p-3 text-[#828282] flex flex-row justify-between w-full items-center">
                    <div class="text-base font-medium">Información de Clases</div>
                    <div id="agregAlumn" class="border rounded-md cursor-pointer bg-blue-600 text-white p-2 text-xs">Agregar Clase</div>
            ...
            <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden flex justify-center items-center fixed top-0 left-0 right-0 z-50 w-screen h-screen p-4 bg-gray-500/50 md:inset-0">
                ...
                <div class="flex flex-col items-center relative w-full h-1/2 max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-700 p-4 lg:px-8">
                    ...
                    <form action="../php/password.php" method="post" id="passwordForm" class="w-full flex flex-col gap-6 relative text-gray-500 mt-4" acction="#">
                        ...
                        <div class="flex flex-col w-full">
                            <label for="email" class="font-semibold">Maestros disponibles para la clase</label>
